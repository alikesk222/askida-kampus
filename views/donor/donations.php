...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-800"><?= t('donor.my_donations') ?></h1>
        <p class="text-gray-500 text-sm mt-1"><?= count($donations) ?> <?= t('common.donations') ?></p>
    </div>
    <a href="<?= url('bagis') ?>"
...
<div class="bg-white rounded-xl shadow-sm p-10 text-center">
    ...
    <p class="text-gray-500"><?= t('donor.no_donations') ?></p>
    ...
    <div class="bg-white rounded-xl shadow-sm p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-4">
            <div class="text-right">
                ...
                <p class="text-xs text-gray-400"><?= t('donor.approved') ?> <?= format_date($d['approved_at'], 'd.m.Y') ?></p>
                <?php endif; ?>
            </div>
