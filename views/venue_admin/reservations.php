...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-800 mt-2">Rezervasyonlar</h1>
...
<div class="bg-white rounded-xl shadow-sm overflow-x-auto">
    <table class="min-w-full divide-y divide-gray-200 text-sm">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr><td colspan="6" class="px-5 py-10 text-center text-gray-400">Rezervasyon bulunamadı.</td></tr>
            <?php else: ?>
