...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
    <a href="<?= url('admin/isletmeler') ?>" class="flex items-center gap-4 bg-white p-5 rounded-xl shadow-sm hover:shadow-md transition">
        <div class="w-12 h-12 bg-[#E0F7FA] rounded-lg flex items-center justify-center">
            <svg class="w-6 h-6 text-[#00A3B4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
            </svg>
        </div>
        <div>
            <p class="font-semibold text-gray-800">İşletmeler</p>
            <p class="text-xs text-gray-400">Ekle, düzenle, ürün yönet</p>
        </div>
    </a>
    <a href="<?= url('admin/bagislar') ?>" class="flex items-center gap-4 bg-white p-5 rounded-xl shadow-sm hover:shadow-md transition">
        ...
        <div>
            <p class="font-semibold text-gray-800">Bağışlar</p>
            <p class="text-xs text-gray-400">Onayla, reddet, listele</p>
        </div>
    </a>
    <a href="<?= url('admin/kullanicilar') ?>" class="flex items-center gap-4 bg-white p-5 rounded-xl shadow-sm hover:shadow-md transition">
        ...
        <div>
            <p class="font-semibold text-gray-800">Kullanıcılar</p>
